...
[![PyPI](https://img.shields.io/pypi/v/cognis-meetingcost.svg)](https://pypi.org/project/cognis-meetingcost/)
[![CI](https://github.com/cognis-digital/meetingcost/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/meetingcost/actions)
...
MEETINGCOST exists for one job — compute the dollar cost of meetings from your calendar (.ics) — and does it without a SaaS bill or heavyweight setup.
...
```bash
meetingcost --version
meetingcost scan .                      # scan the current project
meetingcost scan . --format json
meetingcost scan . --fail-on high       # non-zero exit for CI gates
meetingcost mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Shopify meeting cost calc**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`meetingcost` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
