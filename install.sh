#!/usr/bin/env sh
# Universal installer for meetingcost. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/meetingcost.git"
echo "Installing meetingcost ..."
...
echo "Done. Run: meetingcost --help"
