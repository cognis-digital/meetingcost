"""Native cognis-connect emit for meetingcost — forward findings to any platform.

Maps meetingcost's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    meetingcost ... --format json | meetingcost-emit --to stix
    meetingcost-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
