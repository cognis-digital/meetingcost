"""MEETINGCOST core — Compute the dollar cost of meetings from your calendar (.ics)."""
...
RULES = [
    ("MEE-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("MEE-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("MEE-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
